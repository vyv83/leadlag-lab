...
# Data Quality
quality.html?analysis={analysis_id}                 ← качество данных анализа
```
...
URL: `quality.html?analysis={analysis_id}`
...
- Критерий: `quality.html?analysis=X` показывает красные флаги для Aster/Binance, BBO analysis с медианными спредами, колонку BBO available
